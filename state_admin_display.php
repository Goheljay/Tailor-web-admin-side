...
<head>
    ...
    <title>Display State | tailor web </title>
...
$result=mysqli_query($conn,"SELECT stateid,statename FROM state");
...
<section id="main">
    <div class="container container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h3 style="margin-top: 10px; margin-bottom: 10px;">Welcome to State Amin Panel</h3>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo $retrive['statename'];?></td>
                                <td><a href="update_state.php?state=<?php echo $retrive['stateid']?>" onclick="return confirm('Are You Sure Edit Product?');"><button class='btn btn-success'>Edit</button></a></td>
                                <td><a href='delete_state.php?del=<?php echo $retrive['stateid']?>' onclick="return confirm('Are You Sure Delete Product?');"><button class='btn btn-danger'>Delete</button></a></td>
                            </tr>
                            <?php
                            }
                            ?>
