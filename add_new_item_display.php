...
<head>
    ...
    <title>Display Item | tailor web </title>
...
$result=mysqli_query($conn,'SELECT itemid,itemname,titemid,basicrate,extradesignrate,image FROM itemname');
...
echo "<th>Tailor Item Id</th>";
echo "<th>Basic Rate</th>";
echo "<th>Extra Design Rate</th>";
echo "<th>Image</th>";
echo "<th>Update</th>";
echo "<th>Delete</th>";
echo "</tr>";
...
while ($retrive=mysqli_fetch_array($result)) {
    ...
    $itemname=$retrive['itemname'];
    $titemid=$retrive['titemid'];
    $basicrate=$retrive['basicrate'];
    $extrarate=$retrive['extradesignrate'];
    $image=$retrive['image'];
    echo "<tr align='center'>";
    echo "<td>$itemid</td>";
    echo "<td>$itemname</td>";
    echo "<td>$titemid</td>";
    echo "<td>$basicrate</td>";
    echo "<td>$extrarate</td>";
    echo "<td><img src='upload/$image' alt='wait..' style='height: 70px; widt:80px;'></td>";
    echo "<td><a href='update_item.php?item=$itemid'><button class='btn btn-success'>Edit</button></a></td>";
    echo "<td><a href='delet_item.php?del=$itemid'><button class='btn btn-danger'>Delete</button></a></td>";
    echo "</tr>";
}
echo "</table>";
