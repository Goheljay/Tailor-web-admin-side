...
$stateid=$_GET['state'];
if(isset($stateid)){
    $result=mysqli_query($conn,"SELECT stateid,statename FROM state WHERE stateid='$stateid'") or die("Error");
    $retrive=mysqli_fetch_array($result);
    $ustateid=$retrive['stateid'];
    $ustatename=$retrive['statename'];
}else{
    echo "No data found";
}

if (isset($_POST['edit'])) {
    $statename=$_POST['ustate'];

    $sql=mysqli_query($conn,"UPDATE state SET statename='$statename' WHERE stateid='$stateid'");
    if ($sql) {
                ...
                <!-- <div class="table-responsive"> -->
                    <form method="POST">
                            <div class="form-group text-left col-md-6">
                                ...
                                <input class="form-control" style="cursor: no-drop;" type="text" value="<?php echo $ustateid ?>" name="ustate" readonly>
                            </div>
                            <div class="form-group text-left col-md-6">
                                <label>State Name:</label>
                                <input class="form-control" type="text" value="<?php echo $ustatename?>" name="ustate">
                                <?php echo $msg;?>
                            </div>
                            <br><br><br><br><br>
                            <div class="form-group text-left col-md-6">
